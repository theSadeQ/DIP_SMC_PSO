...
def test_smc_guardrails_and_smokes(monkeypatch):
    ...
    class RealisticClassical:
        def __init__(self, **kwargs):
            self.boundary_layer = kwargs.get("boundary_layer", 0.0)
    ...
    class CfgOk:
        ...
        physics = object()
        controllers = {
            "classical_smc": {"gains": [1, 1, 1]}
        }  # no boundary_layer -> default 0.01
        controller_defaults = {}
    ...
    class StubSwing2:
        def __init__(self, **kwargs):
            self.dt_received = kwargs.get("dt")
    ...
    class CfgDt:
        ...
        physics = object()
        controllers = {
            "swing_up_smc": {"stabilizing_controller": "classical_smc"},
