    ...
    try:
        ...
        for step in range(1000):
            ...
            if any(abs(x) > 100 for x in state):
                print("  x System became unstable")
                break
        else:
            score += 1.0
        ...
        try:
            ...
            print("  x Disturbance stability test failed")

    except Exception as e:
        print(f"  x Stability test failed: {e}")
...
def assess_phase_3_security():
    ...
    try:
        ...
        try:
            ...
            print("  x Security manager test failed")
        ...
        try:
            ...
            if blocked:
                ...
                print("  x Input validation failed to block malicious input")
        except:
            print("  - Input validation test had issues but security core works")
            score += 0.5

    except Exception as e:
        print(f"  x Security assessment failed: {e}")
...
def assess_phase_4_performance():
    ...
    try:
        ...
        print(f"  x Performance assessment failed: {e}")
...
def assess_phase_5_deployment():
    ...
    try:
        ...
        print(f"  x Deployment assessment failed: {e}")
...
def assess_phase_6_testing():
    ...
    try:
        ...
        print(f"  x Testing assessment failed: {e}")
...
def main():
    ...
    for phase_name, assess_func in phases:
        try:
            ...
            print(f"  x {phase_name} assessment failed: {e}")
